...
public class DietVo {
    ...
    public int[] getFoodId0() {
        return foodId0;
    }

    public void setFoodId0(int[] foodId0) {
        this.foodId0 = foodId0;
    }
    ...
    public double[] getFoodNum0() {
        return foodNum0;
    }

    public void setFoodNum0(double[] foodNum0) {
        this.foodNum0 = foodNum0;
    }

    public double[] getFoodNum1() {
        return foodNum1;
    }

    public void setFoodNum1(double[] foodNum1) {
        this.foodNum1 = foodNum1;
    }

    public double[] getFoodNum2() {
        return foodNum2;
    }

    public void setFoodNum2(double[] foodNum2) {
